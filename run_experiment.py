...
if __name__ == '__main__':
    ...
    dataset1_details = {
            ...
            'name': 'wine',
            'readable_name': 'Wine',
            'best_nn_params': {'NN__activation': ['logistic'], 'NN__alpha': [0.047],
                               'NN__hidden_layer_sizes': [(8, 8)], 'NN__learning_rate_init': [0.00596]}
        }
    dataset2_details = {
            ...
            'best_nn_params': {'NN__activation': ['relu'], 'NN__alpha': [1.0],
                               'NN__hidden_layer_sizes': [(82,)], 'NN__learning_rate_init': [0.064]}
    }
    if args.dataset1:
