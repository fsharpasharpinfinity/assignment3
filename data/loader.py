...
class BankData(DataLoader):
    ...
    def __init__(self, path='data/bankdata.csv', verbose=False, seed=1):
        super().__init__(path, verbose, seed)
    ...
    def _preprocess_data(self):
        ...
        to_encode = [1, 2, 3, 4, 6, 7, 8, 10, 12, 15]
...
class WineData(DataLoader):
    def __init__(self, path='data/winqual.csv', verbose=False, seed=1):
        super().__init__(path, verbose, seed)
